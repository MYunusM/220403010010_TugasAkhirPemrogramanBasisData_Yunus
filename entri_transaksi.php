                ...
                <tr>
                  ...
                  <td>
                    <form action="" method="post">
                      <button type="submit" value="<?php echo $r_order['id_order'];?>" name="edit_order" class="btn btn-success btn-mini">&nbsp;&nbsp;Transaksi &nbsp;&nbsp;</button>
                      <button type="submit" value="<?php echo $r_order['id_order'];?>" name="hapus_order" class="btn btn-mini btn-danger">&nbsp; Hapus</button>
                    </form>
                  </td>
                </tr>
                <?php
